...
The random forest model trained with all 52 numeric and integer predictors has the best in-sample accuracy 99.11 %, but was only slightly better than a random forest trained on only the 27 numeric columns.
